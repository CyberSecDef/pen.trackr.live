...
| D23 | Windows test host | **`baldr` (192.168.0.16)** — Windows 11 Pro 26200, Node 22.23.2 matching CI, reachable over SSH. Standing approval to install what testing needs. Documented in `docs/testing.md`. | 5 Sep 2026 (M1) |
